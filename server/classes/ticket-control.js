...
class TicketControl {
    ...
    atenderTicket(escritorio) {
        ...
        let atenderTicket = new Ticket(numeroTicket, escritorio); // nuevo ticket que se va atender con el numero ticket y escritorio

        this.ultimos4.unshift(atenderTicket); // agregar el ticket al inicio del arreglo

        if (this.ultimos4.length > 4) {
            this.ultimos4.splice(-1, 1); // borra el íltimo
        }
